...
display(f"Isn't this fun, {you}? I can feel our day getting more awesome by the minute. I'd wager your day might get even better if you tried Abstra Cloud for free right now.", button_text = "Wanna bet?")

display("You're on. Give me a spin. Go ahead, I dare you.", button_text = "Bring. It. On.")

display_link("https://abstracloud.com/forms",link_text = "Try Abstra Cloud free now", button_text = "On my way now")
